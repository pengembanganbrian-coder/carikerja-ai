...
export default function JobsPage() {
  ...
  useEffect(() => {
    ...
    if (storedJobs) {
      ...
      setSavedJobIds(parsedJobs.map((job) => job.id));
    }
                    ...
                    <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                      ...
                      <div className="flex flex-col gap-3 sm:flex-row">
                        ...
                        <button
                          ...
                          className={
                            isSaved
                              ? "rounded-xl border border-blue-700 bg-blue-50 px-5 py-3 font-semibold text-blue-700 hover:bg-blue-100"
                              : "rounded-xl border border-slate-300 px-5 py-3 font-semibold text-slate-700 hover:bg-slate-100"
                          }
                        >
